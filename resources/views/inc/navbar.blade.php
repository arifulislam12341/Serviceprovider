  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ">
        ...
        <a class="nav-link btn btn-outline-dark text-white text-uppercase fw-bold fst-italic" aria-current="page" href="{{route('home')}}"><b>Home</b></a>
        ...
        <a class="nav-link btn btn-outline-danger text-white text-uppercase  fw-bold fst-italic" href="{{route('serviceproviderDelete')}}"><b>Delete Account</b></a>
